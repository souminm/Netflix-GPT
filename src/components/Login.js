  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-full md:w-3/12 absolute p-12 my-36 mx-auto left-0 right-0 bg-black text-white rounded-lg bg-opacity-80"
      >
        <h1 className="py-4 font-bold text-xl md:text-3xl ">
